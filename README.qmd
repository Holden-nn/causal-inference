...
- January 29: 
- *Probabilistic Machine Learning: An Introduction* Chapter 1
- Milestone 4: Summarize the Data and Fit a Bayesian Regression, Including Prior and Posterior Predictive Plots
...
- February 5: 
- *Probabilistic Machine Learning: An Introduction* Chapter 1
- Milestone 5: Specify a DAG and Fit a Second Model, Including a Counterfactual Plot
...
- March 19: 
- *Probabilistic Machine Learning: An Introduction* Chapter 1
- Milestone 11: Specify a Non-Centered Multilevel Model with Correlated Varying Effects
